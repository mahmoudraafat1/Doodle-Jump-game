...
namespace DoodleJump
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void Init()
        {
            ...
            PlatformController.platforms2 = new System.Collections.Generic.List<Platform2>();
        ...
        private void OnKeyboardPressed(object sender,KeyEventArgs e)
        {
            switch (e.KeyCode.ToString())
            {
                ...
                case "Space":
                    ...
                    PlatformController.CreateBullet(new PointF(player.physics.transform.position.X + player.physics.transform.size.Width/2,player.physics.transform.position.Y));
                    PlatformController.platforms.RemoveAt(5);
                    break;
            }
        }
       ...
       /*     if (PlatformController.platforms.Count > 0)
            {
                ...
                {
                    if (PlatformController.platforms[i].physics.StandartCollide())
                    {
                        PlatformController.RemovePlatform(i);
                        break;
                    }
                }
            }*/
        ...
        public void FollowPlayer()
        {
            ...
            {
                var platform2 = PlatformController.platforms2[i];
        ...
        private void OnRepaint(object sender, PaintEventArgs e)
        {
            ...
            {
                for (int i = 0; i < PlatformController.platforms2.Count; i++)
                    PlatformController.platforms2[i].DrawSprite(g);
            }
            if (PlatformController.bullets.Count > 0)
            {
                for (int i = 0; i < PlatformController.bullets.Count; i++)
