...
namespace DoodleJump.Classes
{
     public static class PlatformController
    {
        ...
        public static List<Platform2> platforms2;
        ...
        public static void AddPlatform2(PointF position)
        {
            Platform2 platform2 = new Platform2(position);
        ...
        public static void GenerateStartSequence2()
        {
            Random r = new Random();
            for (int i = 0; i < 10; i++)
            {
